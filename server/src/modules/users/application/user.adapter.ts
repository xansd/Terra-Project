...
import { IInfrastructureAdapter } from "../../shared/infraestructure/infrastructure-adapter.interface";
import { UserID } from "../domain/value-objects/user-id.value-object";

export class UserAdapter implements IInfrastructureAdapter<IUser, IUserDTO> {
  constructor() {}
