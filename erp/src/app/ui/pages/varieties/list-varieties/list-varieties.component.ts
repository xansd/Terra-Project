...
@Component({
  selector: 'app-list-varieties',
  templateUrl: './list-varieties.component.html',
  styleUrls: ['./list-varieties.component.scss'],
})
export class ListVarietiesComponent {
  ...
  getProducts(): void {
    this.getService
      .getAllProducts(ProductsType.MANCOMUNADOS)
